...
unsigned int nStakeMinAge = 10 * 24 * 60 * 60; // 10 dayss
...
const string strMessageMagic = "mobcoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "mobcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Ferguson in Flames 11-24-2014";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = 1416897218;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 42424242;
		if(fTestNet)
        {
            block.nNonce   = 42424242;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x2d7803c79430905a14ebf33227a8e18cf034b5a5011579db4f6a926f2495c223"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xaf, 0xaf, 0xa1, 0xaf };
